  ...
  return (
    ...
    >
      <View style={{ marginTop: '8%'}}>
        ...
        <FlatList
          style={{...styles.infoBox, width: infoBoxWidth, borderRadius: infoBoxWidth*5/100}}
          scrollEnabled={false}
          horizontal={false}
          numColumns={2}
          ...
          data={[
            ...
            { title: '태어난 해', key: 'item3', measure: '년', param: 'birthYear' },
          ]}
        ...
        <View style={{...styles.healthValueBox, width: infoBoxWidth, borderRadius: infoBoxWidth*5/100}}>
          {info.healthValues.bloodPressure &&
            <ButtonGreen2
            onPressButton={() => setInfo({...info, healthValues: {...info.healthValues, bloodPressure: false}})}
            buttonName='혈압' width={infoBoxWidth*40/100} padding={windowHeight*1.5/100} fontWeight='700' elevation={3}></ButtonGreen2>}
          {!info.healthValues.bloodPressure &&
            <ButtonWhite
            onPressButton={() => setInfo({...info, healthValues: {...info.healthValues, bloodPressure: true}})}
            buttonName='혈압' width={infoBoxWidth*40/100} padding={windowHeight*1.5/100} fontWeight='700' elevation={3}></ButtonWhite>}
          {info.healthValues.bloodSugar &&
            <ButtonGreen2
            onPressButton={() => setInfo({...info, healthValues: {...info.healthValues, bloodSugar: false}})}
            buttonName='혈당' width={infoBoxWidth*40/100} padding={windowHeight*1.5/100} fontWeight='700'></ButtonGreen2>}
          {!info.healthValues.bloodSugar &&
            <ButtonWhite
            onPressButton={() => setInfo({...info, healthValues: {...info.healthValues, bloodSugar: true}})}
            buttonName='혈당' width={infoBoxWidth*40/100} padding={windowHeight*1.5/100} fontWeight='700' elevation={3}></ButtonWhite>}
        </View>
