import { View, Text, StyleSheet, TextInput, Dimensions, ScrollView, TouchableOpacity, Image, Alert } from 'react-native'
...
export default function ConsultantSignUp({ navigation: {navigate} } ) {
  ...
  const signUp = () => {
    ...
    axios.post('https://k6a104.p.ssafy.io/api/expert/join', {
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={{alignItems: 'center', marginTop: '8%', justifyContent: 'center'}}>
        ...
        <View style={{...styles.infoBox, width: infoBoxWidth, borderRadius: infoBoxWidth*5/100}}>
          <Text style={styles.title}>소개글 (최대 100자)</Text>
          <View style={{...styles.infoInputBox,
            height: windowHeight*12/100,
            width: infoInputBoxWidth, borderRadius: infoInputBoxWidth*5/100,elevation: infoInputBoxWidth*1./100}}>
            <TextInput
              style={{}}
              multiline={true}
          ...
          <TouchableOpacity 
            onPress={() => {setIsCareerModalVisible(!isCareerModalVisible)}}
          ...
          <View style={styles.photosContainer}>
            <View style={{alignItems: 'center'}}>
              <Text style={{fontSize: 17, fontWeight: '700'}}>프로필사진</Text>
              {profileImgUri ?
              <TouchableOpacity onPress={() => navigate('CheckImage', { imgType: '프로필사진'})}>
                <Image source={{
                  uri: profileImgUri,
                }}
                style={{...styles.plusButton, width: plusButtonWidth, height: plusButtonWidth, borderRadius: plusButtonWidth*15/100}}/>
              </TouchableOpacity> :
              <TouchableOpacity onPress={() => {onGallery('프로필사진', dispatch)}}>
                <View style={{...styles.plusButton, width: plusButtonWidth, height: plusButtonWidth, borderRadius: plusButtonWidth*15/100}}>
                  <Text style={styles.plusText}>+</Text>
                </View>
              </TouchableOpacity>}
            </View>
            <View style={{alignItems: 'center'}}>
              <Text style={{fontSize: 17, fontWeight: '700'}}>자격 증명서</Text>
              {certImgUri ?
              <TouchableOpacity onPress={() => navigate('CheckImage', { imgType: '자격 증명서'})}>
                <Image source={{
                  uri: certImgUri,
                }}
                style={{...styles.plusButton, width: plusButtonWidth, height: plusButtonWidth, borderRadius: plusButtonWidth*15/100}}/>
              </TouchableOpacity> :
              <TouchableOpacity onPress={() => {onGallery('자격 증명서', dispatch)}}>
                <View style={{...styles.plusButton, width: plusButtonWidth, height: plusButtonWidth, borderRadius: plusButtonWidth*15/100}}>
                  <Text style={styles.plusText}>+</Text>
                </View>
              </TouchableOpacity>}
